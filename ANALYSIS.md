...
```
| Variable | Distance     | Year         | Quarter      | Month        | DayofMonth   |  DayOfWeek   | DepDelayMinutes | AirTime       |
| -------- | ------------ | ------------ | ------------ | ------------ | ------------ | ------------ | --------------- | ------------- |
| count    | 2.000000e+06 | 2.000000e+06 | 2.000000e+06 | 2.000000e+06 | 2.000000e+06 | 2.000000e+06 | 1.963932e+06    | 1.580651e+06  |
| mean     | 7.334963e+02 | 2.004314e+03 | 2.501267e+00 | 6.500761e+00 | 1.572202e+01 | 3.937445e+00 | 1.049667e+01    | 1.059533e+02  |
| std      | 5.684968e+02 | 9.228930e+00 | 1.118022e+00 | 3.443460e+00 | 8.778412e+00 | 1.990369e+00 | 3.196467e+01    | 6.859287e+01  |
| min      | 1.100000e+01 | 1.987000e+03 | 1.000000e+00 | 1.000000e+00 | 1.000000e+00 | 1.000000e+00 | 0.000000e+00    | -7.030000e+02 |
| 25%      | 3.250000e+02 | 1.997000e+03 | 1.000000e+00 | 3.000000e+00 | 8.000000e+00 | 2.000000e+00 | 0.000000e+00    | 5.600000e+01  |
| 50%      | 5.800000e+02 | 2.005000e+03 | 3.000000e+00 | 7.000000e+00 | 1.600000e+01 | 4.000000e+00 | 0.000000e+00    | 8.700000e+01  |
| 75%      | 9.670000e+02 | 2.012000e+03 | 3.000000e+00 | 9.000000e+00 | 2.300000e+01 | 6.000000e+00 | 7.000000e+00    | 1.350000e+02  |
| max      | 5.095000e+03 | 2.020000e+03 | 4.000000e+00 | 1.200000e+01 | 3.100000e+01 | 7.000000e+00 | 1.878000e+03    | 9.650000e+02  |
| dtype    | float64      | float64      | float64      | float64      | float64      | float64      | float64         | float64       |
```

Having this, I can see that the distribution for the variable `Distance` (which is the 55th column), for example, has the expected 2 million rows, its mean value is 733 miles, and its values are in the range [11, 5095].
...
* DepDelayMinutes: the real result for this range is [0, 106.39]. This is slightly above percentile 98.
* AirTime: the real result for this range is [0, 311.73]. This is slightly above percentile 98. XXXXXXXXXXXXXXXXXXXXXXXXX CHECK!!!!!
...
The goal is to extract meaningful insights from data by identifying patterns, trends, and relationships. This process can aid in predictive modeling and anomaly identification. They are located in the [folder step_4_analizing/plots/](step_4_analizing/plots/), and follow this naming convention: `4-Histogram_bivariate-<variable1>-<variable2>-NO_OUTLIERS.png`.
...
I have created three different plots to visualize some trends:
* A plot to compare the number of flights which are marked as delayed in the arrival planned time versus those who are not, for every carrier in the data set.
   * It has been generated by running the simplified [Python script step_4_1_analizing_numofflights.py](step_4_analizing/step_4_1_analizing_numofflights.py).
* A plot like the previous one, but for the departure delays. It has been generated using the same script.
...
* TOBEDONE A plot that XXXX

Total cancelled flights: 36462 among 2M
That's 0.018%
16243 without Cancellation Code - 44.5%

I have decided not to study further on the Cancellation Code, due to 
...
Next steps:
Cancellation code: relate the cancellation code with the number of total cancellation flights, per carrier, for example. Also could be analised per season, etc...

Limitations:
Seaborn library dos not allow to show numbers on top of bars so the total occurencies of the data analysed is more visual.